...
We proudly partner with visionary organizations to create lasting impact. Join us in transforming lives and ecosystems through trees.')); ?>
        ...
        <div class="featured-posts">
            <div class="frame-127-1">
                <div class="join-the-conversation subtitle-2"><?php echo esc_html(forestplanet_get_field('featured_posts_subtitle', null, 'JOIN THE CONVERSATION')); ?></div>
                <div class="featured-posts-1 librebaskerville-normal-mirage-48px"><?php echo esc_html(forestplanet_get_field('featured_posts_title', null, 'Featured Posts')); ?></div>
            </div>
            <div class="frame-420">
                <div class="x-embed">
                    <?php 
                    // Get Instagram embed URL from ACF
                    $instagram_url_1 = forestplanet_get_field('instagram_embed_1', null, 'https://www.instagram.com/p/DCU3zEMyHaM/');
                    if (!empty($instagram_url_1)) :
                        // Extract post ID from URL
                        preg_match('/instagram.com\/p\/([^\/]+)/', $instagram_url_1, $matches);
                        $post_id = !empty($matches[1]) ? $matches[1] : 'DCU3zEMyHaM';
                    ?>
                    <!-- Instagram embed - Primary embed -->
                    <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" data-instgrm-version="14" style="background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:calc(100% - 2px);">
                        <div style="padding:16px;">
                            <a href="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" style="background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
                            ...
                            <p style="color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                <a href="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" style="color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">A post shared by ForestPlanet (@forestplanetorg)</a>
                            </p>
                        </div>
                    </blockquote>
                    <?php endif; ?>
                    ...
                    <?php
                    // Second and third Instagram embeds (mobile will show just first one)
                    $instagram_url_2 = forestplanet_get_field('instagram_embed_2', null, '');
                    $instagram_url_3 = forestplanet_get_field('instagram_embed_3', null, '');
                    // These will be used in desktop view
                    ?>
                ...
                <div class="x-embed-1">
                    ...
                    <?php
                    // Get YouTube embed URLs from ACF
                    $youtube_url_1 = forestplanet_get_field('youtube_embed_1', null, 'https://www.youtube.com/watch?v=dBT04Iw3fy8');
                    $youtube_url_2 = forestplanet_get_field('youtube_embed_2', null, 'https://www.youtube.com/watch?v=S8fYxcD3RyU');
                    ...
                    $youtube_embed_1 = get_youtube_embed_url($youtube_url_1);
                    $youtube_embed_2 = get_youtube_embed_url($youtube_url_2);
                    ?>
                    
                    <?php if (!empty($youtube_embed_1)) : ?>
                    <div class="youtube-container">
                        <iframe width="560" height="315" src="<?php echo esc_url($youtube_embed_1); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                    <?php endif; ?>
                    
                    <?php if (!empty($youtube_embed_2)) : ?>
                    <div class="youtube-container">
                        <iframe width="560" height="315" src="<?php echo esc_url($youtube_embed_2); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
We proudly partner with visionary organizations to create lasting impact. Join us in transforming lives and ecosystems through trees.')); ?>
        ...
        <div class="featured-posts-2">
            <div class="featured-posts-heading">
                <div class="join-the-conversation-1 subtitle-2"><?php echo esc_html(forestplanet_get_field('featured_posts_subtitle', null, 'JOIN THE CONVERSATION')); ?></div>
                <div class="featured-posts-3 librebaskerville-normal-mirage-64px"><?php echo esc_html(forestplanet_get_field('featured_posts_title', null, 'Featured Posts')); ?></div>
            </div>
            <div class="frame-418">
                <div class="x-embed">
                    <?php 
                    // Instagram embeds for desktop view (can show up to 3)
                    $instagram_embeds = array(
                        forestplanet_get_field('instagram_embed_1', null, 'https://www.instagram.com/p/DCU3zEMyHaM/'),
                        forestplanet_get_field('instagram_embed_2', null, ''),
                        forestplanet_get_field('instagram_embed_3', null, '')
                    );
                    
                    // Display first Instagram embed (always show if available)
                    if (!empty($instagram_embeds[0])) :
                        preg_match('/instagram.com\/p\/([^\/]+)/', $instagram_embeds[0], $matches);
                        $post_id = !empty($matches[1]) ? $matches[1] : 'DCU3zEMyHaM';
                    ?>
                    <!-- Instagram embed - Primary embed for desktop -->
                    <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" data-instgrm-version="14" style="background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:calc(100% - 2px);">
                        <div style="padding:16px;">
                            <a href="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" style="background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
                                <div style="display: flex; flex-direction: row; align-items: center;">
                    ...
                    <?php
                    // Display additional Instagram embeds if available (desktop only)
                    for ($i = 1; $i < 3; $i++) :
                        if (!empty($instagram_embeds[$i])) :
                            preg_match('/instagram.com\/p\/([^\/]+)/', $instagram_embeds[$i], $matches);
                            $post_id = !empty($matches[1]) ? $matches[1] : '';
                            if (!empty($post_id)) :
                    ?>
                    <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" data-instgrm-version="14" style="margin-top: 20px; background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:calc(100% - 2px);">
                        <div style="padding:16px;">
                            <a href="https://www.instagram.com/p/<?php echo esc_attr($post_id); ?>/" style="background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
                ...
                <div class="x-embed-1">
                    <!-- YouTube embeds for desktop view -->
                    <?php
                    // Same YouTube embeds as mobile, reuse the variables
                    if (!empty($youtube_embed_1)) : 
                    ?>
                    <div class="youtube-container">
                        <iframe width="560" height="315" src="<?php echo esc_url($youtube_embed_1); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
