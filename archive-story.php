<?php
/**
 * The template for displaying story archives
 *
...
// Get story categories for filtering
...
<div class="stories-mobile screen">
    <div class="main-content">
        <div class="hero">
            <div class="frame-301">
                ...
                <div class="catagories">
                    <a href="<?php echo esc_url(get_post_type_archive_link('story')); ?>" class="category-link">
                        <article class="secondary-button-mirage secondary-button active">
            ...
            <?php 
            // Set up a custom query just for the featured post
            $latest_args = array(
                'post_type' => 'story',
                'posts_per_page' => 1,
                'orderby' => 'date',
        ...
        <div class="story-cards story">
            <div class="card-grid">
                ...
                if($grid_query->have_posts()): 
                    ...
                    <p class="no-results"><?php esc_html_e('No stories found.', 'forestplanet'); ?></p>
                <?php endif;
    ...
    <div class="main-content-1">
        <div class="hero-1">
            <div class="frame-1 frame">
                <h1 class="title-1"><?php post_type_archive_title(); ?></h1>
